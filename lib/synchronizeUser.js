  ...
  const options = {
    ...
    args: {
      parameter: {
        ...
        EnterpriseId: person.organizationNumber, // * The role’s organization unit. Set to either it’s external id or enterprise number, or recno on the format “recno:123”
        AccessGroups: [
          {
